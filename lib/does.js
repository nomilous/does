    ...
    lastInstance = local = {
      ...
      */
      ...
      expectFn: function(_arg) {
        var expects, fn, fnName, functions, object, original, spy, uuid, _ref, _ref1;
        ...
        return _ref1 = functions[fnName] || (functions[fnName] = {
          expects: [],
          original: {
            fn: object[fnName]
          }
        }), expects = _ref1.expects, original = _ref1.original, _ref1;
      },
      verify: function() {}
    };
  } else {
