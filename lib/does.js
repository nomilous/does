    ...
    lastInstance = local = {
      ...
      */
      ...
      reset: deferred(function(action) {
        var entities, expectation, expects, functionName, functions, functionsCount, name, object, original, uuid, _ref, _ref1;
        ...
        for (uuid in entities) {
          ...
          for (functionName in functions) {
            ...
            expectation = expects[0].expectation;
            if (!expectation) {
              continue;
            }
            if (original.fn != null) {
        ...
        action.resolve();
        return console.log({
          TODO: 'dangling beforeAll may still be preset'
        });
      }),
